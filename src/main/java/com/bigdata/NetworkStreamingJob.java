 ...
 */
public class NetworkStreamingJob {
	...
	public static void main(String[] args) throws Exception {
        ...
        DataStreamSource ds = env.socketTextStream("127.0.0.1",9999,"\n");
...
//        ms.print();
        ...
        SingleOutputStreamOperator sums =  ms.keyBy(0).timeWindow(Time.seconds(15)).sum(1);
        sums.print();
